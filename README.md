...
## **_Cómo programar un Buscaminas utilizando herramientas de JavaScript_**
...
**_En la consola, escribimos pintarTablero(5,6)_**
...
**_Si recargamos el navegador y en la consola ejecutamos pintarTablero(5,6) nos saldrá el tablero que le indiquemos._**
...
**_Si refrescamos la pantalla y pintamos el tablero de nuevo nos dará un error, porque los escuchadores de eventos estamos intentando vincularlos a funciones que aún no hemos definido: marcar y destapar._**
